...
This is the next iteration of my metacomputation tooling. This iteration uses s expressions for the meta compilation and a bytecode language for the base computation substrate. 
